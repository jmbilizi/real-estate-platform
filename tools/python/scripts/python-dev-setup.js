...
if (args.includes("--help") || args.includes("-h")) {
  ...
  console.log("  Installs UV if not present, then runs `uv sync` to create .venv and install packages.");
  console.log("");
  console.log("Actions:");
  ...
  if (isWindows) {
    ...
    if (!result.success) {
      ...
      if (!wingetResult.success) {
        ...
        log("Please install UV manually: https://docs.astral.sh/uv/getting-started/installation/", true);
        return false;
      }
    }
