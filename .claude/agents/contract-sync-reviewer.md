...
<!-- GENERATED by tools/agents/sync-providers.js — do not edit; edit the canonical file in .agents/agents/contract-sync-reviewer.md and run "pnpm run agents:sync". -->
