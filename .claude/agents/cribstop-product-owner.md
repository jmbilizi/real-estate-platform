...
<!-- GENERATED by tools/agents/sync-providers.js — do not edit; edit the canonical file in .agents/agents/cribstop-product-owner.md and run "pnpm run agents:sync". -->
