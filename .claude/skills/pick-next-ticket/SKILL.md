...
Full board/command reference: `.github/copilot-instructions.md` → "Product Backlog (GitHub Issues &
Projects)". Never call `gh`/`git` directly for this — always the `pnpm run gh:ticket:*` wrappers.
