...
export async function POST(req: Request) {
  ...
  const upstream = await fetchGateway(
    ...
    console.error('Gateway resend-confirmation-email failed', err);
    return null;
  });
  ...
  // Identity answers 200 for unknown, unconfirmed and confirmed addresses alike (#147). Forward
  // that as-is. Never translate this into "account found" or "no account found".
