              ...
              <div className="mt-3">
                ...
                <div className="grid grid-cols-7 mb-1">
                  {['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa'].map((d) => (
                    <span
                      key={d}
                      className="text-center text-[11px] text-ink-muted font-medium py-1"
                    >
                      {d}
                    </span>
                  ))}
                ...
                <div className="grid grid-cols-7 gap-y-1">
                  {Array.from({ length: firstDayOffset(calMonth.year, calMonth.month) }).map(
                    (_, i) => (
                      <span key={`e${i}`} />
                    ),
                  )}
                  {Array.from({ length: daysInMonth(calMonth.year, calMonth.month) }).map(
                    (_, i) => {
                      const d = i + 1;
