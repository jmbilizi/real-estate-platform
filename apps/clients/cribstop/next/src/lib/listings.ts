...
let listings: Listing[] = [
  ...
  },
  {
    ...
    brokerPhone: '(202) 555-0411',
    brokerEmail: 'p.nguyen@longandfoster.com',
    officeName: 'Long & Foster Real Estate',
    officeBrokerLeadPhone: '(202) 555-0400',
    officeBrokerLeadMail: 'dc-office@longandfoster.com',
    ...
    featured: true,
    priceReduced: true,
    listedBy: 'Patricia Nguyen – Long & Foster Real Estate',
  },
  {
    id: '3',
    ...
    brokerName: 'Thomas Reed',
    brokerPhone: '(443) 555-0821',
    brokerEmail: 't.reed@coldwellbanker.com',
    officeName: 'Coldwell Banker Realty',
    officeBrokerLeadPhone: '(443) 555-0800',
    officeBrokerLeadMail: 'baltimore@coldwellbanker.com',
    ...
    listedBy: 'Thomas Reed – Coldwell Banker Realty',
  },
  {
    id: '4',
    ...
    brokerPhone: '(301) 555-0755',
    brokerEmail: 'c.park@ttrsir.com',
    officeName: "TTR Sotheby's International Realty",
    officeBrokerLeadPhone: '(301) 555-0700',
    officeBrokerLeadMail: 'bethesda@ttrsir.com',
    ...
    listedBy: "Christine Park – TTR Sotheby's International Realty",
  },
  {
    id: '5',
    ...
    brokerName: 'Marcus Williams',
    brokerPhone: '(202) 555-0588',
    brokerEmail: 'm.williams@compass.com',
    officeName: 'Compass',
    officeBrokerLeadPhone: '(202) 555-0550',
    officeBrokerLeadMail: 'dc@compass.com',
    ...
    longitude: -76.9996,
    featured: false,
    listedBy: 'Marcus Williams – Compass',
  },
  {
    id: '6',
    ...
    brokerName: 'Evelyn Strauss',
    brokerPhone: '(703) 555-0622',
    brokerEmail: 'e.strauss@wfp.com',
    officeName: 'Washington Fine Properties',
    officeBrokerLeadPhone: '(703) 555-0600',
    officeBrokerLeadMail: 'tysons@wfp.com',
    ...
    longitude: -77.2205,
    featured: true,
    listedBy: 'Evelyn Strauss – Washington Fine Properties',
  },
  {
    id: '7',
    ...
    yearBuilt: 1945,
    imageUrls: [IMG(1600585154340), IMG(1600596542815), IMG(1502672260266), IMG(1600607687939)],
    brokerName: 'Kevin Okonkwo',
    brokerPhone: '(443) 555-0934',
    brokerEmail: 'k.okonkwo@bhhspenfed.com',
    officeName: 'Berkshire Hathaway HomeServices PenFed Realty',
    officeBrokerLeadPhone: '(443) 555-0900',
    officeBrokerLeadMail: 'baltimore@bhhspenfed.com',
    ...
    longitude: -76.6368,
    featured: false,
    listedBy: 'Kevin Okonkwo – Berkshire Hathaway HomeServices PenFed Realty',
  },
  {
    id: '8',
    ...
    brokerName: 'Aisha Brennan',
    brokerPhone: '(202) 555-0317',
    brokerEmail: 'a.brennan@compass.com',
    officeName: 'Compass',
    officeBrokerLeadPhone: '(202) 555-0550',
    officeBrokerLeadMail: 'dc@compass.com',
    ...
    longitude: -77.0329,
    featured: false,
    listedBy: 'Aisha Brennan – Compass',
  },
  {
    id: '9',
    ...
    brokerName: 'Jonathan Heller',
    brokerPhone: '(410) 555-0278',
    brokerEmail: 'j.heller@longandfoster.com',
    officeName: 'Long & Foster Real Estate',
    officeBrokerLeadPhone: '(410) 555-0250',
    officeBrokerLeadMail: 'baltimore@longandfoster.com',
    ...
    featured: false,
    priceReduced: true,
    listedBy: 'Jonathan Heller – Long & Foster Real Estate',
  },
  {
    id: '10',
    ...
    brokerName: 'Renée Dubois',
    brokerPhone: '(410) 555-0463',
    brokerEmail: 'r.dubois@corcoranmc.com',
    officeName: 'Corcoran McEnearney',
    officeBrokerLeadPhone: '(410) 555-0440',
    officeBrokerLeadMail: 'baltimore@corcoranmc.com',
    ...
    listedBy: 'Renée Dubois – Corcoran McEnearney',
  },
  {
    id: '11',
    ...
    brokerName: 'Danielle Foster',
    brokerPhone: '(301) 555-0147',
    brokerEmail: 'd.foster@kw.com',
    officeName: 'Keller Williams Capital Properties',
    officeBrokerLeadPhone: '(301) 555-0100',
    officeBrokerLeadMail: 'silverspring@kw.com',
    ...
    longitude: -77.0261,
    featured: false,
    listedBy: 'Danielle Foster – Keller Williams Capital Properties',
  },
  {
    id: '12',
    ...
    brokerName: 'Gregory Walsh',
    brokerPhone: '(703) 555-0892',
    brokerEmail: 'g.walsh@ttrsir.com',
    officeName: "TTR Sotheby's International Realty",
    officeBrokerLeadPhone: '(703) 555-0700',
    officeBrokerLeadMail: 'oldtown@ttrsir.com',
    ...
    longitude: -77.0524,
    featured: true,
    listedBy: "Gregory Walsh – TTR Sotheby's International Realty",
  },
];
...
for (let i = 0; i < 36; i++) {
  ...
  listings.push({
    ...
    openHouse:
      i % 4 === 0
        ? { date: '2026-05-0' + ((i % 9) + 1), startTime: '12:00 PM', endTime: '2:00 PM' }
        : undefined,
    priceReduced: i % 5 === 0,
