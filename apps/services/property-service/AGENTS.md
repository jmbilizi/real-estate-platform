...
- **"Not configured" is a success, exit 0.** An environment holding the committed
  `StrongBase64Password` placeholder has no credential yet, and `config.ts` treats that literal as
